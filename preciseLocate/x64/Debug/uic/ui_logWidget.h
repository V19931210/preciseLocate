...
public:
    ...
    void setupUi(QWidget *logWidgetClass)
    {
        ...
        logWidgetClass->resize(600, 400);
        logWidget = new QTextEdit(logWidgetClass);
        logWidget->setObjectName(QString::fromUtf8("logWidget"));
        logWidget->setGeometry(QRect(0, 0, 571, 241));
        pushButton = new QPushButton(logWidgetClass);
    ...
    void retranslateUi(QWidget *logWidgetClass)
    {
        ...
        pushButton->setText(QCoreApplication::translate("logWidgetClass", "PushButton", nullptr));
    } // retranslateUi
